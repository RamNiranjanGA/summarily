...
with open('d:/PROJECTS/summarizer/summarizer.jsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
style_and_header_pattern = re.compile(r'<style>\{`.*?`\}</style>\s*<div className="header">.*?</div>', re.DOTALL)

new_style_and_header = r"""<style>{`
...
content = style_and_header_pattern.sub(new_style_and_header, content)

with open('d:/PROJECTS/summarizer/summarizer.jsx', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated summarizer.jsx successfully!")
